---
title: "Beyer Orchard Layout (TREE PLANTING YEAR)"
output:
  html_document:
    df_print: paged
    code_folding: "hide"
...
columnlabs2 <- c("A","B","C","D","E","F",
  ...
  ggplot(filter(trees_final3, Row > 58), aes(as.numeric(Column), Row)) + geom_tile(aes(fill = as.factor(TreePlantDate)),colour = "white",size=2.2) + 
  ...
  labs(fill = "Tree Planting Year",x="ROAD",y="RUNWAY")
